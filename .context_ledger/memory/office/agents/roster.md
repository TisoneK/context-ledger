...
| Ilya | S016 | deepseek/deepseek-flash | Fix the two broken `.ps1` ports in the ledger package upstream — Windows sessions cannot pass the exit gate | Working | Signed in after syncing a stale checkout; entrance read pending |
